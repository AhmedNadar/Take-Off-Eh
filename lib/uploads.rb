...
# As of now, ActiveStorage does not provide any built-in methods for image processing despite using MiniMagick for transformations. 
# So to have the same functionality, as for example CarrierWave offers, you need to do some work. 
# I created lib called Uploads where I keep all my code for various resizes based on CarrierWave and optimization based on Google's PageSpeed documentation for image optimization.
