<template>
  <div
    class="max-w-4xl mx-auto bg-gray-100 border-t-2 border-l-2 border-r-2 border-black rounded-t-lg shadow-sm"
  >
    <div class="grid grid-cols-1 lg:grid-cols-12">
      ...
      >
        ...
        <h3 class="text-sm font-black lg:text-xl">Purchase</h3>
      </div>
    </div>
  </div>
</template>
